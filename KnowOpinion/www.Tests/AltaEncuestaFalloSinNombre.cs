...
{
    [TestClass]
    public class AltaEncuestaFalloSinNombre
    {
        ...
        [TestMethod]
        public void TheAltaEncuestaFalloSinNombreTest()
        {
            ...
            driver.FindElement(By.Id("TBox_Descripcion")).SendKeys("Descripcion de la prueba 1");
