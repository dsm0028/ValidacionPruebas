...
{
    [TestClass]
    public class AltaEncuestaFalloSinDescripcion
    {
        ...
        [TestMethod]
        public void TheAltaEncuestaFalloSinDescripcionTest()
        {
            ...
            driver.FindElement(By.Id("TBox_NombreEncuesta")).SendKeys("Prueba 1");
