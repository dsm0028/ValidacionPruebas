...
{
    [TestClass]
    public class ActivarDesactivarEncuestaFalloSinElecciones
    {
        ...
        [TestMethod]
        public void TheActivarDesactivarEncuestaFalloSinEleccionesTest()
        {
            ...
            new SelectElement(driver.FindElement(By.Id("DropDownList_SelecEncu"))).SelectByText("Prueba 2");
            ...
            // Warning: assertTextPresent may require manual changes
            Assert.IsTrue(Regex.IsMatch(driver.FindElement(By.CssSelector("BODY")).Text, "^[\\s\\S]*$"));
            Assert.AreEqual("No se ha elegido nada!", driver.FindElement(By.Id("Lbl_err")).Text);
        }
