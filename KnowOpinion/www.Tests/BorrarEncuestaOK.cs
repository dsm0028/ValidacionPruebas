...
namespace SeleniumTests
{
    ...
    public class BorrarEncuestaOK
    {
        ...
        [TestMethod]
        public void TheBorrarEncuestaOKTest()
        {
            ...
            driver.FindElement(By.Id("Button_BorrarEncuesta")).Click();
            new SelectElement(driver.FindElement(By.Id("Seleccionar_BorrarEncuesta"))).SelectByText("Prueba 3");
