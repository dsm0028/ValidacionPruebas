...
namespace SeleniumTests
{
    ...
    public class AltaEncuestaOK
    {
        ...
        [TestMethod]
        public void TheAltaEncuestaOKTest()
        {
            ...
            driver.FindElement(By.Id("TBox_NombreEncuesta")).Clear();
            driver.FindElement(By.Id("TBox_NombreEncuesta")).SendKeys("Nueva Encuesta");
            driver.FindElement(By.Id("TBox_Descripcion")).Clear();
            driver.FindElement(By.Id("TBox_Descripcion")).SendKeys("Descripcion de la nueva encuesta");
