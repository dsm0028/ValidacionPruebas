...
{
    [TestClass]
    public class ModificarEncuestaFallo
    {
        ...
        [TestMethod]
        public void TheModificarEncuestaFalloTest()
        {
            ...
            driver.Navigate().GoToUrl(baseURL + "/ModificarEncuesta.aspx");
            ...
            Assert.AreEqual("No se ha modificado nada.", driver.FindElement(By.Id("Lbl_ErrorModificar")).Text);
