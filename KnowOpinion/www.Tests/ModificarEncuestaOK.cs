...
{
    [TestClass]
    public class ModificarEncuestaOK
    {
        ...
        [TestMethod]
        public void TheModificarEncuestaOKTest()
        {
            ...
            driver.FindElement(By.Id("TextBox_NuevoT")).SendKeys("Encuesta 3");
            driver.FindElement(By.Id("Tb_NuevaD")).Clear();
            driver.FindElement(By.Id("Tb_NuevaD")).SendKeys("Descripcion de la encuesta 3");
