...
{
    [TestClass]
    public class ActivarDesactivarEncuestaFallo2Elecciones
    {
        ...
        [TestMethod]
        public void TheActivarDesactivarEncuestaFallo2EleccionesTest()
        {
            ...
            driver.FindElement(By.Id("Button_ADEncuesta")).Click();
            new SelectElement(driver.FindElement(By.Id("DropDownList_SelecEncu"))).SelectByText("Prueba 3");
            driver.FindElement(By.Id("CheckBox_Activar")).Click();
            driver.FindElement(By.Id("CheckBox_Desactivar")).Click();
            ...
            // Warning: assertTextPresent may require manual changes
            Assert.IsTrue(Regex.IsMatch(driver.FindElement(By.CssSelector("BODY")).Text, "^[\\s\\S]*$"));
            Assert.AreEqual("Elija solo una opción.", driver.FindElement(By.Id("Lbl_err")).Text);
        }
